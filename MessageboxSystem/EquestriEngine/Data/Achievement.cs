...
namespace EquestriEngine.Data
{
    ...
    {
        ValueON,    //SWITCH Exclusive
        ValueOFF,   //SWITCH Exclusive
        ValueEqual, //Used for Ints and strings
        ValueGreater, //Used for ints
        ValueGreaterEqual, //Used for ints
        ValueLess, //Used for ints
        ValueLessEqual //Used for ints
    }
                ...
                if (sender is Variable)
                {
                    switch (_checkValue)
                    {
                        ...
                        case CheckValue.ValueLess:
                            ...
                            break;
                        case CheckValue.ValueLessEqual:
                            if ((sender as Variable).LessThan((int)_value + 1))
                                GiveReward();
                            break;
                        case CheckValue.ValueGreater:
                            ...
                            break;
                        case CheckValue.ValueGreaterEqual:
                            if ((sender as Variable).GreaterThan((int)_value - 1))
                                GiveReward();
                            break;
                    }
                }
